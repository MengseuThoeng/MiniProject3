        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-700">
              ...
              explore various categories, brands, and specifications tailored to
              your preferences. Whether you're hunting for the latest trends,
              searching for specific features, or simply browsing for
